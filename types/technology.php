...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="index.php">News Media 24-Hours</a>
  ...
  <div class="content-wrapper">
    <?php
error_reporting(0);
$result = file_get_contents("https://newsapi.org/v2/top-headlines?country=in&category=technology&apiKey=88b894304f86462da17308dc87be662d");
