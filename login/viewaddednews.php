    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <h1>View Added News</h1>
          </li>
      </ol>
     
        
                     <?php
$result=mysqli_query($con,"select * from tbl_addnews where checkid='$d'");
...
?>
                  ...
                  <?php echo $heading;?>
                  <img src="../login/myfolder/<?php echo $photo;?>" style='width:75px;height:75px;'>
                    <?php echo $date;?>
                    <td><?php echo $data;?>
                  
                    <tr>
                    <td><?php echo "<a href='deletenews.php?id=$did' style='color:red'>Delete News</a></td>"?>
