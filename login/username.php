...
<body>
    ...
    <div class="osx-login">
  <center><img src="../images/24media2.png" width="155px" height="155px"></center>
  <form method="post">
  <input type="text " class="password" placeholder="Enter Your Username" name="username"/>
        <div>
				   <input type="submit" id="button2" value="Next" name="sub1"/>
            <br>
             <a href="register.php" style="color:green;text-decoration:none;">Register</a>
				</div>
</div>
        </form>
