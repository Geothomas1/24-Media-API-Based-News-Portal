...
$result=mysqli_query($con,"select * from tbl_portal where ccode='$getdata'");
while($row=mysqli_fetch_array($result))
{
$cname=$row[1];
$ccode=$row[2];    
$_SESSION['cnamec']=$cname;
$_SESSION['ccodec']=$ccode;
?>
<html lang="en">
...
<head>
  ...
  <title>Search By Countries</title>
  <!-- Bootstrap core CSS-->
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="#">News From &nbsp;<?php echo $cname;?></a>
...
$result = file_get_contents("https://newsapi.org/v2/top-headlines?country=".$ccode."&apiKey=88b894304f86462da17308dc87be662d");
